...
class Check: Svg {
    ...
    override fun draw(c: Canvas, w: Int, h: Int, dx: Int, dy: Int) {
        ...
        t.reset()
        t.moveTo(18.0f, 22.0f)
        t.lineTo(4.0f, 22.0f)
        t.cubicTo(2.9f, 22.0f, 2.0f, 21.1f, 2.0f, 20.0f)
        t.lineTo(2.0f, 8.0f)
        t.cubicTo(2.0f, 6.9f, 2.9f, 6.0f, 4.0f, 6.0f)
        t.lineTo(14.0f, 6.0f)
        t.lineTo(14.0f, 8.0f)
        t.lineTo(4.0f, 8.0f)
        t.lineTo(4.0f, 20.0f)
        t.lineTo(18.0f, 20.0f)
        t.lineTo(18.0f, 15.0f)
        t.lineTo(20.0f, 15.0f)
        t.lineTo(20.0f, 20.0f)
        t.cubicTo(20.0f, 21.1f, 19.1f, 22.0f, 18.0f, 22.0f)
        ...
        c.save()
        t.reset()
        t.moveTo(11.04f, 17.81f)
        t.lineTo(6.12f, 12.88f)
        t.lineTo(7.88f, 11.12f)
        t.lineTo(10.96f, 14.19f)
        t.lineTo(20.07f, 4.16f)
        t.lineTo(21.93f, 5.84f)
        t.lineTo(11.04f, 17.81f)
